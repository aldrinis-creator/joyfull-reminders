...
- [x] Replace the authenticated tab bar and add the Orders destination.
- [x] Move Calendar access to People and Profile access to the Today avatar.
- [x] Reduce ReminderCard to one contextual action plus Done, with overflow sheet actions.
